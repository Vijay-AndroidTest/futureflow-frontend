           ...
           <div className="max-w-7xl mx-auto px-6 flex justify-start gap-8">
             {nav?.topNavItems ? nav.topNavItems.map((item, idx) => (
               ...
               <>
                 ...
                 <Link href="#" className="text-[10px] font-bold text-slate-400 uppercase tracking-widest cursor-pointer hover:text-slate-900">Article</Link>
                 <Link href="#" className="text-[10px] font-bold text-slate-400 uppercase tracking-widest cursor-pointer hover:text-slate-900">Category</Link>
               </>
             )}
           </div>
        </div>
